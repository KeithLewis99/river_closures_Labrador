...
```{r figs SFA 1-2, message = FALSE, echo = FALSE, warning = FALSE}
for (i in seq_along(rivers[1:13])) {
p1 <-    ggplot() +
   ...
   {if(!is.na(df_stat_all[df_stat_all$river == rivers[i], "mon19_24"])){
      geom_vline(xintercept = df_stat_all[df_stat_all$river == rivers[i], "mon19_24"], linetype = 'dotdash')      
   }} +
   {if(!is.na(df_stat_all[df_stat_all$river == rivers[i], "mon18_24"])){
      geom_vline(xintercept = df_stat_all[df_stat_all$river == rivers[i], "mon18_24"], linetype = 'dotted')
   }} +
   {if(!is.na(df_stat_all[df_stat_all$river == rivers[i], "close19_24"])){
      geom_vline(xintercept = df_stat_all[df_stat_all$river == rivers[i], "close19_24"], linetype = 'dotdash')
   }} +
   {if(!is.na(df_stat_all[df_stat_all$river == rivers[i], "close18_24"])){
      geom_vline(xintercept = df_stat_all[df_stat_all$river == rivers[i], "close18_24"], linetype = 'dotted')
   }} +
   {if(!is.na(df_stat_all[df_stat_all$river == rivers[i], "mon19_23"])){
      geom_vline(xintercept = df_stat_all[df_stat_all$river == rivers[i], "mon19_23"], linetype = 'dotdash')      
   }} +
   {if(!is.na(df_stat_all[df_stat_all$river == rivers[i], "mon18_23"])){
      geom_vline(xintercept = df_stat_all[df_stat_all$river == rivers[i], "mon18_23"], linetype = 'dotted')
   }} +
   {if(!is.na(df_stat_all[df_stat_all$river == rivers[i], "close19_23"])){
      geom_vline(xintercept = df_stat_all[df_stat_all$river == rivers[i], "close19_23"], linetype = 'dotdash')
   }} +
   {if(!is.na(df_stat_all[df_stat_all$river == rivers[i], "close18_23"])){
      geom_vline(xintercept = df_stat_all[df_stat_all$river == rivers[i], "close18_23"], linetype = 'dotted')
   }} +
